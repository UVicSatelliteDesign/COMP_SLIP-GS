...
class ReceivedPacket():
    ...
    ########## Passing data to app layer will be handled in main.py
    ...
    #         return
        ...
        #     handle_telemetry_data(self.payload) # TODO:
        # elif self.payload_type in [0b0100, 0b0101, 0b0110, 0b0111]:
        #     handle_camer1_end(self.payload) # TODO:
